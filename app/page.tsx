    ...
    <>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-16">
        ...
        <div className="mt-6 grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          <ServiceCard title="Investigación de personas y empresas" description="Rastreo OSINT en fuentes públicas para personas/empresas." href="/servicios/antecedentes-fuentes-abiertas" price="Desde USD 99" />
